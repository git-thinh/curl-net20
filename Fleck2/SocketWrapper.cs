...
namespace Fleck2
{
    public class SocketWrapper : ISocket
    {
        ...
        public void Receive(byte[] buffer, Action<int> callback, Action<Exception> error, int offset = 0)
        {
      
            Func<AsyncCallback, object, IAsyncResult> begin = (cb, data) =>
        ...
        public void Accept(Action<ISocket> callback, Action<Exception> error)
        {
            ...
            Func<IAsyncResult, ICancellationToken, ISocket> end = (result, token) =>
            {
